...
migrate: setuppostgres
	cd migrations && GOOSE_DBSTRING="user=$DB_USERNAME password=$DB_PASSWORD host=$DB_HOST sslmode=disable dbname=moviesdatabase" GOOSE_DRIVER="postgres" goose up && cd ..
